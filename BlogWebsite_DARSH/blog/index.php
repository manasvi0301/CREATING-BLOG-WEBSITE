    ...
    <footer class="footer mt-auto py-3 bg-primary text-white">
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <h5>About My Blog</h5>
                    <p>A blog sharing insights on various topics such as nature, mindfulness, culinary adventures, and more. Join us on a journey of discovery and learning.</p>
                </div>
                <div class="col-md-4">
                    <h5>Contact Us</h5>
                    <p>Email: jayjalaram25104@gmail.com</p>
                    <p>Phone: 8200548930</p>
                </div>
                <div class="col-md-4">
                    <h5>Follow Us</h5>
